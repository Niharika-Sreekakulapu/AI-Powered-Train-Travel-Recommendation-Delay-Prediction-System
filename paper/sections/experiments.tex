...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\textwidth]{figs/residual_hist.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\textwidth]{figs/calibration_curve.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\textwidth]{figs/residual_vs_pred.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.48\textwidth]{figs/distance_dist.png}
